...
public class ItemExcaliber: MonoBehaviour
{
    ...
    [SerializeField] private GameObject _excaliber;
    [SerializeField] private GameObject _playerWeapon;
    [SerializeField] private GameObject _playerExcaliberWeapon;
    [SerializeField] private GameObject _excaliberParticles;
    [SerializeField] public TMP_Text ProgressText;
    [SerializeField] private AudioManager audioBehaviour;
